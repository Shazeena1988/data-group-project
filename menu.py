...
from datetime import datetime       #import datetime clas
...
final_order = []            #creates an empty dictionary which will be used to store orders
...
def start():
    ...
    Would you like to place an order y/n: """) # A small amount of ascii for our menu
